...
public class FrontController extends HttpServlet {
    ...
    /**
     * リクエストパラメータの値から該当するActionクラスのインスタンスを作成し、返却する (例:パラメータが action=Employee
     * の場合、actions.EmployeeActionオブジェクト)
     *
     * @param request リクエスト
    ...
    private ActionBase getAction(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            action = (ActionBase) (type.asSubclass(ActionBase.class).getDeclaredConstructor()
                    .newInstance());
