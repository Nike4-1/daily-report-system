...
public class EmployeeService extends ServiceBase {
    ...
    public List<EmployeeView> getPerPage(int page) {
        List<Employee> employees = em.createNamedQuery(JpaConst.Q_EMP_GET_ALL, Employee.class)
                ...
                .setMaxResults(JpaConst.ROW_PER_PAGE).getResultList();
    ...
    public long countAll() {
        long empCount =
                (long) em.createNamedQuery(JpaConst.Q_EMP_COUNT, Long.class).getSingleResult();
    ...
    public EmployeeView findOne(String code, String plainPass, String pepper) {
        ...
        try {
            ...
            e = em.createNamedQuery(JpaConst.Q_EMP_GET_BY_CODE_AND_PASS, Employee.class)
                    ...
                    .setParameter(JpaConst.JPQL_PARM_PASSWORD, pass).getSingleResult();
    ...
    public long countByCode(String code) {
        ...
        long employees_count =
                (long) em.createNamedQuery(JpaConst.Q_EMP_COUNT_RESISTERED_BY_CODE, Long.class)
    ...
    public List<String> update(EmployeeView ev, String pepper) {
        ...
        // 更新内容についてバリデーションを行う
        List<String> errors =
                EmployeeValidator.validate(this, savedEmp, validateCode, validatePass);
